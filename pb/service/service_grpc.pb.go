...
const (
	...
	HelloWorldService_HelloWorld2_FullMethodName = "/service.HelloWorldService/HelloWorld2"
)
...
type HelloWorldServiceClient interface {
	...
	HelloWorld2(ctx context.Context, in *HelloWorldRequest, opts ...grpc.CallOption) (*HelloWorldResponse, error)
}
...
func (c *helloWorldServiceClient) HelloWorld2(ctx context.Context, in *HelloWorldRequest, opts ...grpc.CallOption) (*HelloWorldResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HelloWorldResponse)
	err := c.cc.Invoke(ctx, HelloWorldService_HelloWorld2_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHelloWorldServiceServer) HelloWorld2(context.Context, *HelloWorldRequest) (*HelloWorldResponse, error) {
...
func _HelloWorldService_HelloWorld2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloWorldRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HelloWorldServiceServer).HelloWorld2(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HelloWorldService_HelloWorld2_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloWorldServiceServer).HelloWorld2(ctx, req.(*HelloWorldRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HelloWorldService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _HelloWorldService_HelloWorld2_Handler,
		},
	},
